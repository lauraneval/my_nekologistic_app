  ...
  class _TaskListScreenState extends State<TaskListScreen> {
            ...
            child: CustomScrollView(
              slivers: [
                ...
                if (tasks.error != null)
                  ...
                  SliverToBoxAdapter(child: _buildMapThumbnail(tasks.activeTasks)),
    ...
    Widget _buildMapThumbnail(List<MobileTaskItem> tasks) {
      final targets = tasks.where((t) => t.hasCoordinates).toList();
      ...
      final center = LatLng(
        targets.first.latitude!,
        targets.first.longitude!,
      );
        ...
        child: FlutterMap(
          ...
          children: [
            TileLayer(
              ...
              userAgentPackageName: 'com.nekologistic.app',
            ),

            MarkerLayer(
              markers: targets.map((task) {
                return Marker(
                  point: LatLng(
                    task.latitude!,
                    task.longitude!,
